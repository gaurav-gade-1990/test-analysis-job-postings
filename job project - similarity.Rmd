...
df = read.csv("C:/Users/nagar/Documents/ANLY 540 Language Modeling/Similarity/completed_clean_data.csv")
...
#import data
df = pd.read_csv('C:/Users/nagar/Documents/ANLY 540 Language Modeling/Similarity/completed_clean_data.csv')
#cleanup for this specific example
df = df[['AUTHOR', 'JOURNAL', 'TITLE', 'YEAR', 'ABSTRACT']]
...
#cleanup for this specific example
df = df[['JobRequirment', 'JobRequirment', 'Title', 'Date', 'Company']]
df.dropna(inplace=True)
df.info()
